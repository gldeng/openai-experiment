...
# 20. Change Siamese as breed, remove pursed mouth
export BASE_PROMPT="A simple pixel art image of a Siamese cat in a natural sitting pose with 4 legs on the floor, facing directly at the viewer,"
export EXTRA_DESC=""
export DB_NAME=cat_samples_progressive_0306_20
export NO_REORG=1
