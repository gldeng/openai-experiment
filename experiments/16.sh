...
export BASE_PROMPT="A simple 128x128 grid pixel art image of a Chartreux cat in a natural sitting pose with 4 legs on the floor, facing directly at the viewer,"
export EXTRA_DESC=""
export DB_NAME=cat_samples_progressive_0305_16
export NO_REORG=1
